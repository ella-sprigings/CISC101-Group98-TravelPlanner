* `/modules/00_reference_framework.md` — # AI Travel Planner — Internal Reference Framework
...
* `/modules/01_intake_setup.md` — ### **Module 1 — Intake & Setup**
...
* `/modules/02_plan_builder.md` — ### **Module 2 — Plan Builder (Options → Days)**
...
* `/modules/03_feasibility_guardrails.md` — ### **Module 3 — Feasibility & Guardrails**
...
* `/modules/04_render_refine.md` — Show results clearly and conversationally:
...
* `/modules/presentation_rule.md` — ## Presentation Rule
...
* `/modules/quality_targets.md` — ## Quality Targets (Internal)
